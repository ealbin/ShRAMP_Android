...
public class ImageProcessor {
    ...
    // mInstance....................................................................................
    // TODO: description
    private static final ImageProcessor mInstance = new ImageProcessor();
    ...
    private static class AnalysisHelper {
        ...
        private AnalysisHelper() {
            //Log.e(Thread.currentThread().getName(), "ImageProcessor.AnalysisHelper AnalysisHelper");
        ...
        private void analyze() {
            ...
            //synchronized (DO_NOT_DISTURB)
            {
                ...
                Log.e(Thread.currentThread().getName(), "ImageProcessor.AnalysisHelper analyze");
        ...
        private void clear() {
            //synchronized (DO_NOT_DISTURB)
            {
                Log.e(Thread.currentThread().getName(), "ImageProcessor.AnalysisHelper clear");
                //nImageAlloc.destroy();
        ...
        private void update(@NonNull ResultHelper resultHelper) {
            synchronized (DO_NOT_DISTURB)
            {
                Log.e(Thread.currentThread().getName(), "ImageProcessor.AnalysisHelper update");
                ...
                */
                ...
                synchronized (QUEUE_ACCESS_LOCK) {
                    ...
                    if (resultQueueSize == 0 && imageQueueSize == 0) {
                        Log.e(Thread.currentThread().getName(), "ImageProcessor queue is empty");
                        mPendingJobs += 1;
        ...
        private void updateImage(@NonNull byte[] data) {
            synchronized (DO_NOT_DISTURB) {
                //Log.e(Thread.currentThread().getName(), "ImageProcessor.AnalysisHelper updateImage");
                if (nImageAlloc != null) {
    ...
    private static class ResultHelper {
        ...
        private ResultHelper(@NonNull TotalCaptureResult result) {
            //synchronized (DO_NOT_DISTURB)
            {
                //Log.e(Thread.currentThread().getName(), "ImageProcessor.ResultHelper ResultHelper");
    ...
    private ImageProcessor() {
        //Log.e(Thread.currentThread().getName(), "ImageProcessor ImageProcessor");
    }
    ...
    public static void init(@NonNull Activity activity) {
        ...
        //synchronized (DO_NOT_DISTURB)
        {
            ...
            //Log.e(Thread.currentThread().getName(), "ImageProcessor init");
    ...
    public synchronized static void post(Runnable runnable) {
        mPendingJobs += 1;
        Log.e(Thread.currentThread().getName(), "ImageProcessor post, pending jobs: " + Integer.toString(mPendingJobs));
    ...
    public static void processImage(TotalCaptureResult result) {
        synchronized (QUEUE_ACCESS_LOCK) {
            Log.e(Thread.currentThread().getName(), "ImageProcessor Queuing TotalCaptureResult, time code: " + TimeCode.toString(result.get(CaptureResult.SENSOR_TIMESTAMP)));
    ...
    public static void processImage(byte[] imageBytes, long timestamp) {
        synchronized (QUEUE_ACCESS_LOCK) {
            Log.e(Thread.currentThread().getName(), "ImageProcessor Queuing byte[], time code: " + TimeCode.toString(timestamp));
    ...
    public static void processStatistics() {
        ...
        if (GlobalSettings.DEBUG_DISABLE_STATISTICS) {
            Log.e(Thread.currentThread().getName(), "ImageProcessor would do statistics at this point");
        }
        else {
            Log.e(Thread.currentThread().getName(), "ImageProcessor processStatistics");
    ...
    public static void reset() {
        Log.e(Thread.currentThread().getName(), "ImageProcessor reset");
        synchronized (QUEUE_ACCESS_LOCK) {
    ...
    private static void processImage() {
        ...
        //synchronized (DO_NOT_DISTURB)
        {
            ...
            synchronized (QUEUE_ACCESS_LOCK) {
                ...
                Log.e(Thread.currentThread().getName(), "ImageProcessor Pause Capture = " + Boolean.toString(mPauseCapture));
                ...
                if (!mPauseCapture) {
                    ...
                    if (resultQueueSize == 0 && imageQueueSize == 0) {
                        if (mPendingJobs <= 0) { // TODO: fix negative pending jobs
                            Log.e(Thread.currentThread().getName(), "ImageProcessor queue is empty, signaling CaptureOverseer");
                    ...
                    if (resultQueueSize == 0 || imageQueueSize == 0) {
                        Log.e(Thread.currentThread().getName(), "ImageProcessor processImage (waiting) " +
                    ...
                    if (resultQueueSize == 0 || imageQueueSize == 0 || backlog == 1) {
                        Log.e(Thread.currentThread().getName(), "ImageProcessor restart capture>>>>>>>>>>>>");
                        mPauseCapture = false;
            ...
            Log.e(Thread.currentThread().getName(), "ImageProcessor processImage, time code: (result) " +
            ...
            Log.e(Thread.currentThread().getName(), "ImageProcessor Free Heap Memory: " + Long.toString(freeMiB) + " [MiB]");
